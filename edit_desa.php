...
<?php
				$id=$_GET['id'];
                  include'maps/db.php';
                  $i=0; 
                  $tampil2 = "SELECT * from desa,kabupaten,kecamatan WHERE kabupaten.id_kabupaten=kecamatan.id_kabupaten and kecamatan.id_kecamatan=desa.id_kecamatan and desa.id_desa='$id'";
...
<div class="bs-docs-section mar-b-30">
  ...
  <div class="bs-callout bs-callout-info">
    <form class="form-horizontal" role="form" action="proses/proses_edit_desa.php" method="POST">
	 <div class="form-group">
	  
        <label for="inputEmail3" class="col-sm-2 control-label">Id Desa</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="inputEmail3" placeholder="Nama Desa" required name="id_desa" value="<?php echo $data2['id_desa']?>">
        </div>
      </div>
      <div class="form-group">
